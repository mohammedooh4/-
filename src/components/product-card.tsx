...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="group block cursor-pointer" onClick={handleCardClick} tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && handleCardClick()}>
      <Card className="h-full overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1.5 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-lg flex flex-col group-focus:ring-2 group-focus:ring-primary group-focus:ring-offset-2 bg-card/50">
